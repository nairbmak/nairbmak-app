  ...
  constructor() {
    ...
    this.state = {
      data: {
        ...
        Interval: null,
        ReasonForUse: null,
        ADRRemittedAfterStoppingOrCuttingBackOnSuspectDrug: null,
        ADRReappearedAfterRestartingSuspectDrugSimilarDrug: null,
      }
    }
    ...
    return (
      <div className="col-12">
        <div className="row">
          ...
          <CheckboxText
            pop="box secondary"
            title={<p>ADR remitted after stopping or cutting back on suspect drug?</p>}
            name="ADRRemittedAfterStoppingOrCuttingBackOnSuspectDrug"
            options={['Yes', 'No', 'Not done', 'Unknown']}
            onChange={this.onChange}
            size='6'
          />
          <CheckboxText
            pop="box secondary"
            title={<p>ADR reappeared after restarting suspect drug/similar drug?:</p>}
            name="ADRReappearedAfterRestartingSuspectDrugSimilarDrug"
            options={['Yes', 'No', 'Not done', 'Unknown']}
            onChange={this.onChange}
            size='6'
          />
